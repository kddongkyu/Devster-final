    ...
    (rb_idx, currentPage = null) => {
      ...
      axiosIns
        ...
        .then((response) => {
          ...
          if (m_idx && rb_idx) {
            axiosIns
              .get(`/api/review/D1/${m_idx}/checkGood/${rb_idx}`)
              .then((response) => {
            ...
            axiosIns
              .get(`/api/review/D1/${m_idx}/checkBad/${rb_idx}`)
              .then((response) => {
        ...
        if (response.data === 2) {
          ...
          axiosIns
            ...
            .then((response) => {
              if (response.data === 1) {
                axiosIns
                  .post(`/api/review/D1/${m_idx}/like/${rb_idx}`)
                  .then((response) => {
                    fetchReview(rb_idx, currentPage);
                  })
                  .catch((error) => {
        ...
        if (response.data === 1) {
          ...
          axiosIns
            ...
            .then((response) => {
              if (response.data === 2) {
                axiosIns
                  .post(`/api/review/D1/${m_idx}/dislike/${rb_idx}`)
                  .then((response) => {
                    fetchReview(rb_idx, currentPage);
                  })
                  .catch((error) => {
  ...
  return (
    <div className="review-detail">
      <div className="advertise-box">
        <img className="advertise-main" alt="" src={ad1} />
      </div>
      ...
      <div className="review-detail-comp">
        ...
        <div className="review-detail-comp-info">
          ...
          <div className="review-detail-comp-info-stars-icon">
        ...
        <div className="review-detail-comp-info-text">
          <ul className="review-detail-ul">
            ...
            <li className="cisal_li">
              평균연봉 : {Number(reviewData.ciSal).toLocaleString("ko-KR")}원
            </li>
          </ul>
        </div>
      </div>
      <div className="review-detail-header">
        <div className="review-detail-info">
          <img
            ...
            src={
              reviewData.mPhoto
                ? `${profileUrl}${reviewData.mPhoto}`
                : require("./assets/logo_profile.svg").default
            }
            onClick={handleNicknameClick}
          />
          <div
            className="review-detail-info-nickname"
            onClick={handleNicknameClick}
          >
            {reviewData.mNicname}
          </div>
          <div className="review-detail-info-status">
            ...
            <img
              ...
              alt=""
              src={
                require("./assets/review_detail_info_status_views.svg").default
              }
            />
            <div className="review-detail-info-status-text1">
              <span className="rview-readcount">
                {reviewData.review.rb_readcount}
              </span>
            </div>
          </div>
        </div>
        <img
          ...
          alt=""
          src={
            require("./assets/review_detail_header_function_url.svg").default
          }
        />
      ...
      <div className="review-detail-body">
        <div className="review-detail-body-subject">
          {reviewData.review.rb_subject}
        </div>
        <div className="review-detail-body-text">
          <pre
            className="review-detail-textarea-pre"
        ...
        <div className="review-detail-listbackcounter">
          <div className="review-detail-listback" onClick={reviewNavigation}>
            ...
            <img
              ...
              alt=""
              src={
                require("../fboard/assets/boarddetail/board_detail_listback_icon.svg")
                  .default
              }
            />
          </div>
          <div className="review-detail-counter">
            <div className="review-detail-counter-like">
              <div
                className="review-detail-counter-like-box"
              ...
              <img
                ...
                alt=""
                src={
                  require("./assets/review_detail_counter_like_icon.svg")
                    .default
                }
            ...
            <div
              className="review-detail-counter-dislike"
            ...
            >
              ...
              <img
                ...
                alt=""
                src={
                  require("./assets/review_detail_counter_dislike_icon.svg")
                    .default
                }
              />
            </div>
        ...
        <div className="review-detail-advertise-box2">
          <img className="advertise-main" alt="" src={ad2} />
        </div>
      </div>
