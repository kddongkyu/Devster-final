...
function AboardDetail(props) {
  ...
  const fetchAboard = useCallback(
    (ab_idx, currentPage = null) => {
      ...
      axiosIns
        ...
        .then((response) => {
          ...
          if (m_idx && ab_idx) {
            axiosIns
              .get(`/api/academyboard/D0/${m_idx}/checkGood/${ab_idx}`)
              .then((response) => {
            ...
            axiosIns
              .get(`/api/academyboard/D0/${m_idx}/checkBad/${ab_idx}`)
              .then((response) => {
        ...
        if (response.data === 2) {
          ...
          axiosIns
            ...
            .then((response) => {
              if (response.data === 1) {
                axiosIns
                  .post(`/api/academyboard/D1/${m_idx}/like/${ab_idx}`)
                  .then((response) => {
                    fetchAboard(ab_idx, currentPage);
                  })
                  .catch((error) => {
        ...
        if (response.data === 1) {
          ...
          axiosIns
            ...
            .then((response) => {
              if (response.data === 2) {
                axiosIns
                  .post(`/api/academyboard/D1/${m_idx}/dislike/${ab_idx}`)
                  .then((response) => {
                    fetchAboard(ab_idx, currentPage);
                  })
                  .catch((error) => {
  ...
  const deleteAboard = (ab_idx) => {
    if (window.confirm("해당 게시글을 삭제하시겠습니까?")) {
      axiosIns
        .delete(`/api/academyboard/D1/${ab_idx}`)
        .then((response) => {
    ...
    <div className="aboard-detail">
      ...
      <div className="aboard-detail-info">
        <img
          ...
          src={
            aboardDate.mPhoto
              ? `${profileUrl}${aboardDate.mPhoto}`
              : require("./assets/logo_profile.svg").default
          }
          onClick={handleNicknameClick}
        />
        <div
          className="aboard-detail-info-nickname"
          onClick={handleNicknameClick}
        >
          {aboardDate.mNicname}
        </div>
        ...
        <div className="aboard-detail-info-status-text1">
          {timeForToday(aboardDate.aboard.ab_writeday)}
        </div>
        <img
          className="aboard-detail-info-status-view-icon"
          alt=""
          src={
            require("./assets/aboarddetail/aboard_detail_info_status_views.svg")
              .default
          }
        />
      </div>
      ...
      {m_idx === aboardDate.aboard.m_idx && (
        <>
          <img
            ...
            alt=""
            src={
              require("./assets/aboarddetail/aboard_update_icon.svg").default
            }
          ...
          <img
            ...
            alt=""
            src={
              require("./assets/aboarddetail/aboard_delete_icon.svg").default
            }
      ...
      <div className="aboard-detail-textarea">
        ...
        <div className="aboard-detail-textarea-contents">
          <pre
            className="aboard-detail-textarea-pre"
          ...
          <div className="aboard-detail-listbackcounter">
            <div className="aboard-detail-listback" onClick={aboardNavigation}>
              ...
              <img
                ...
                alt=""
                src={
                  require("./assets/aboarddetail/aboard_detail_listback_icon.svg")
                    .default
                }
              />
            </div>
            <div className="aboard-detail-counter">
              <div className="aboard-detail-counter-like">
                <div
                  className="aboard-detail-counter-like-box"
                ...
                <img
                  ...
                  alt=""
                  src={
                    require("./assets/aboarddetail/aboard_detail_counter_like_icon.svg")
                      .default
                  }
                  onClick={() => handlelike(m_idx, ab_idx)}
                />
              ...
              <div className="aboard-detail-counter-dislike">
                <div
                  className="aboard-detail-counter-dislike-"
                ...
                <img
                  ...
                  alt=""
                  src={
                    require("./assets/aboarddetail/aboard_detail_counter_dislike_icon.svg")
                      .default
                  }
                  onClick={() => handleDislike(m_idx, ab_idx)}
                />
