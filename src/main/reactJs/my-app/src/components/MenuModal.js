            ...
            <div className="moblie-menu-modal">
...

                {
                    !isLoggedIn
                        ...
                        : (
                            decodedToken.type === "company"
                                ? (
                                    <div className="menu-modal-options">
                                        <NavLink to={"/notice/admin"} onClick={closeMenuBar}>
                                            <b className="menu-modal-options-not">공지사항</b>
                                        </NavLink>
                                        <NavLink to={"/resumelist"} onClick={closeMenuBar}>
                                            <b className="menu-modal-options-resume">구직자 이력서 열람</b>
                                        </NavLink>
                                        <NavLink to={"/fboard"} onClick={closeMenuBar}>
                                            <b className="menu-modal-options-fb3">일반게시판</b>
                                        </NavLink>
                                        <NavLink to={"/qboard"} onClick={closeMenuBar}>
                                            <div className="menu-modal-options-qna3">Q&A</div>
                                        </NavLink>
                                        <NavLink to={"/hboard"} onClick={closeMenuBar}>
                                            <b className="menu-modal-options-hire3">채용정보</b>
                                        </NavLink>
                                        <NavLink to={"/review"} onClick={closeMenuBar}>
                                            <b className="menu-modal-options-review3">회사후기</b>
                                        </NavLink>
                                    </div>
                                )
                                : (
